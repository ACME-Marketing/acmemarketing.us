-- Reset Tables Only - This preserves your Supabase project
-- Run this in the SQL Editor to clean up the database tables
...
CREATE INDEX idx_episodes_enabled ON episodes(enabled);
